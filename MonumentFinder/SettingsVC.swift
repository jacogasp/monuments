    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        default:
            ...
            if options[indexPath.row] != nil {
                ...
                } else {	// If next cell is not nil, then cell should expand
                ...
                if parentCellIndex == 1 {        // maxVisibility setting
                    ...
                    let selectedDistance = (options[parentCellIndex]!.subOptions![childCellSubIndex]
						as! (String, Int)).1
